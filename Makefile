IMAGE = final-project-squad5
PACKAGE = final_project_squad5
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ final_project_squad5 <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf final_project_squad5.egg_info
