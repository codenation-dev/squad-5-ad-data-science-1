...
```
git clone https://github.com/<@github_username>/final-project-squad5.git
cd final-project-squad5
```
...
* [final_project_squad5](./final_project_squad5/): main Python package with source of the model.
